...
var MainManager = function() {
    ...
    i(),
    aidn.util.webaudio ? ($("#ng").css("display", "none"), $(".ok").css("display", "block"), m && $("#scene_main .attention").html("杞昏Е &amp; 婊戝姩!"), u || $("#scene_top .attention").text("* 鎶婂０闊冲紑澶х偣锛岀劧鍚庝韩鍙楀惂锛�")) : ($("#ng").css("display", "block"), $(".ok").css("display", "none"), u || $("#ng .atten").html("鎶辨瓑锛�</br>浣犵殑娴忚鍣ㄤ笉鏀椤甸潰")),
